...
public interface RxApi {
    ...
    Observable<ResponseBody> getUserQueryMap(@QueryMap Map<String, Object> map);
    ...
    @Multipart
    @POST("upload.jhtml")
    Observable<String> uploadFile(@Part MultipartBody.Part file, @Part("data") String data);

    //@MultipartMap 多文件上传
    @Multipart
    @POST("uploads.jhtml")
    Observable<String> uploadFiles(@PartMap Map<String, RequestBody> uploadFiles, @Part("data") String data);
}
